...
# Define the output schema using json schema
review_summary_schema ={
  "type": "object",
  "properties": {
    "Summary": {
      "type": "string",
      "description": "Write a concise summary of the review in 2-3 sentences."
    },
    "sentiment": {
      "type": "string",
    ...
    "pros": {
      ...
      "description": "List the positive aspects mentioned in the review."
    },
    "cons": {
      "type": "array",
      "items": {
      ...
      "description": "List the negative aspects mentioned in the review."
    }
  },
  "required": ["Summary", "sentiment"]
}

# prompt = json.dumps(review_summary_schema)
...
structured_model = model.with_structured_output(review_summary_schema)
